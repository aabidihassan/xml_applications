    ...
    <xsl:template match="complexType">
        <xsl:choose>
            <xsl:when test="@name">
                ...
                <xsl:value-of select="@name"/>_id INT NOT NULL,<br/>                 
    ...
    <xsl:template match="@type">
        ...
        <xsl:choose>
            <xsl:when test="$type = 'string' or $type = 'token' or $type = 'String' or $type = 'STRING'">
                <xsl:value-of select="../@name"/> VARCHAR2 (*),<br/>
            </xsl:when>
            ...
            <xsl:when test="$type = 'integer' or $type = 'Integer' or $type = 'INTEGER'">
                <xsl:value-of select="../@name"/> INTEGER (10,0),<br/>
            </xsl:when>
            ...
            <xsl:when test="$type = 'decimal' or $type = 'Decimal' or $type = 'DECIMAL'">
                <xsl:value-of select="../@name"/> DECIMAL(30,15),<br/>
            </xsl:when>
